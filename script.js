...
const projects = [
    ...
    },
    {
        ...
        screenshots: [
            { img: "images/dl01.jpg", desc: "Gradio UI for Skin Cancer Predictions System with a few training model" },
            { img: "images/dl02.jpg", desc: "Hair removal function for the uploaded images" },
            { img: "images/dl03.jpg", desc: "Model comparison for the predicted results" }
        ]
    },
    {
        id: 4,
